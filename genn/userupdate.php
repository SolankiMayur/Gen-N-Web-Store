<?php
	...
	{	
			...
			$q="update user set u_name='$_POST[name]',u_email='$_POST[email]',u_mno=$_POST[contact],u_city='$_POST[city]',u_address='$_POST[address]',u_pcode=$_POST[pincode] where u_id=$u";
			if(mysql_query($q))
				{
					echo "<script>
		...
		<div class="row">
			...
			<div class="col-md-6" >
				...
				<h2 class="bordered">Update Your Details</h2>
					...
					<form role="form" class="register-form cf-style-1" name="userform" id="userform" method="post" onSubmit="return chkUserEdit();">
						<div class="field-row">
                           
                            <label>Name</label>
                            <input type="text" class="le-input" name="name" value='<?php echo $v['u_name']; ?>' >
                        </div><!-- /.field-row -->
						
						<div class="field-row">
                            <label>Email</label>
                            <input type="text" class="le-input" name="email" value='<?php echo $v['u_email'];?>'>
                        </div>
						<div class="field-row">
                            <label>Contact No</label>
                            <input type="text" class="le-input" name="contact" maxlength="10" value='<?php echo $v['u_mno'];?>'>
                        </div>
						<div class="field-row">
                            <label>City</label>
                            <select  name="city">
					<option value='<?php echo $v['u_city']; ?>' label='<?php echo $v['u_city'];?>' selected class="le-select"></option>';
						...
						<div class="field-row">
                            <label>Address</label>
                            <textarea class="le-input" rows="6" name="address" ><?php echo $v['u_address'];?></textarea>
                        </div>
						<div class="field-row">
                            <label>Pincode</label>
                            <input type="text" class="le-input" maxlength="6" name="pincode" value='<?php echo $v['u_pcode'];?>'>
                        </div>
