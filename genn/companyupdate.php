<?php
	...
	{	
			...
			$q="update company set org_name='$_POST[orgname]',owner_name='$_POST[ownername]',c_email='$_POST[email]',c_mno=$_POST[contact],c_city='$_POST[city]',c_address='$_POST[address]',c_pcode=$_POST[pincode] where c_id=$u";
			if(mysql_query($q))
				{
					echo "<script>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6" >
				...
				<h2 class="bordered">Update Your Details</h2>
					
					
						
                            <label>Company Details : </label>
					<form role="form" class="register-form cf-style-1" name="compform" id="compform" method="post" onSubmit="return chkCompEdit();">
						<div class="field-row">
                           
                            <label>Company Name</label>
                            <input type="text" class="le-input" name="orgname" value='<?php echo $v['org_name']; ?>' >
                        </div><!-- /.field-row -->
						
						<div class="field-row">
                            <label>Owner Name</label>
                            <input type="text" class="le-input" name="ownername" value='<?php echo $v['owner_name'];?>'>
                        </div>
						<div class="field-row">
                            <label>Contact No</label>
                            <input type="text" class="le-input" name="contact" maxlength="10" value='<?php echo $v['c_mno'];?>'>
                        </div>
						<div class="field-row">
                            <label>Email</label>
                            <input type="text" class="le-input" name="email"  value='<?php echo $v['c_email'];?>'>
                        </div>
						<div class="field-row">
                            <label>City</label>
                            <select  name="city">
					<option value='<?php echo $v['c_city']; ?>' label='<?php echo $v['c_city'];?>' selected class="le-select"></option>';
						...
						<div class="field-row">
                            <label>Address</label>
                            <textarea class="le-input" rows="6" name="address" ><?php echo $v['c_address'];?></textarea>
                        </div>
						<div class="field-row">
                            <label>Pincode</label>
                            <input type="text" class="le-input" maxlength="6" name="pincode" value='<?php echo $v['c_pcode'];?>'>
                        </div>
                        <div class="buttons-holder">
                            <button type="submit" class="le-button huge" name="regcomp">Update</button>
                        </div><!-- /.buttons-holder -->
					</form>
